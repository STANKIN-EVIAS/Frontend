...
import registrationPet from "assets/unnamed (4)-no-bg-preview (carve.photos).png";
import imgPhoto202510220002481 from "assets/unnamed (5)-no-bg-preview (carve.photos).png";
import charityAnimal from "assets/unnamed (7)-edited-free (carve.photos) (9).png";
    ...
    return (
        <div className="consultation-card">
            ...
            <div className="consultation-description">
                <p>успей проконсультароваться со специалистом до 31 ноября</p>
            </div>
            <Frame39 />
        </div>
    );
        ...
        <div className="homepage-container">
            <div className="homepage-inner">
                ...
                <div className="content-block">
                    <div className="content-text">
                        <p className="text-justify">
                            <strong>
                                Единая Ветеринарная Информационно-Аналитическая
                                Система (ЕВИАС)
                            </strong>{" "}
                            — это централизованная цифровая платформа, созданная
                            для комплексного решения задач в сфере ветеринарии и
                            заботы о здоровье животных.
                        </p>
                    </div>
                ...
                <div className="content-block ">
                    ...
                    <div className="content-text">
                        <p className="text-justify">
                            Система объединяет владельцев домашних животных,
                            ветеринарных врачей, клиники и государственные
                            контролирующие органы, обеспечивая слаженное
                            взаимодействие между всеми участниками процесса.
                            Благодаря ЕВИАС владельцы животных получают удобный
                            доступ к записи на приёмы, ведению цифровых
                            медицинских карт питомцев и истории их лечения.
                        </p>
                    </div>
                </div>
                ...
                <div className="content-block ">
                    <div className="content-text">
                        <p className="text-justify">
                            Ветеринарные специалисты и клиники используют
                            платформу для автоматизации рабочего процесса,
                            ведения документации и быстрого обмена информацией.
                            На уровне государства система позволяет осуществлять
                            мониторинг отрасли, контролировать
                            эпидемиологическую обстановку и повышать общие
                ...
                <div className="charity-section">
                    ...
                    <div className="charity-card">
                        ...
                        <div className="charity-image">
                            ...
                            <img
                                src={charityAnimal}
                                alt="Бездомное животное, нуждающееся в помощи"
                            />
                        </div>
                        ...
                        <p className="charity-description">
                            Вместе с ЕВИАС мы создаем не просто технологичную
                            среду для питомцев, но и поддерживаем тех, кто в ней
                            больше всего нуждается. Ваши пожертвования
                            направляются на лечение и содержание животных из
                            приютов, помогая им обрести здоровье и новую семью.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="registration-card">
                        ...
                        <div className="registration-subtitle">
                            <p>
                                ...
                                записаться на встречу со специалистом или
                                получить первую бесплатную онлайн консультацию
                            </p>
                        </div>
